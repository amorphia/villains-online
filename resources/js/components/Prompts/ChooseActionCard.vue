                        ...
                        <horizontal-scroll classes="choose-target__wrap d-flex pb-3 width-100 plan-block" buttons="true">
                            <div class="d-flex pb-3 width-100 justify-center"
                                ...
                                <div class='plan-block__image-wrap'
                                     ...
                                     :class="{ selected : card.selected, 'opacity-5' : card.type !== type }">
    ...
    export default {
        ...
        methods : {
            ...
            resolve( action ){
                ...
                data = { ...this.data, ...data };
                this.shared.respond( 'choose-action-card', data );
            },
        ...
        computed : {
            type(){
                return this.data.type ?? 'rule';
            },

            message(){
                if(this.data.message) return this.data.message;

                return `Choose a rule card to play in the ${this.data.area}${ this.data.free ? ' for free' : ''}`;
            },
