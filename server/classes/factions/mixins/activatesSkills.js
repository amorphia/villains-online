let obj = {
    ...
    readySkilledUnits() {
        ...
        this.data.units.forEach( unit => {
            if( !unit.cannotBeReady && _.unitInPlay( unit, { skilled : true } ) ) unit.ready = true;
            if( unit.ready && ( unit.cannotBeReady || !unit.skilled || !unit.location || unit.killed ) ) unit.ready = false;
        });
    }
